...
-- Set language and encoding of error messages
...
CREATE TABLE relationship_entity (
    ...
    FOREIGN KEY (relationship_id) REFERENCES relationship (
        id
    ) ON DELETE CASCADE,
...
CREATE TABLE transaction (
    ...
    beneficiary_id INT,
    payer_type VARCHAR(50) NOT NULL CHECK (
        payer_type IN ('business', 'person')
    ),
    payer_id INT,
...
CREATE TABLE transaction_occasion (
    transaction_id INT,
    occasion_id INT,
    CONSTRAINT transaction_occasion_id PRIMARY KEY (
        transaction_id, occasion_id
    ),
...
CREATE TABLE transaction_category (
    transaction_id INT,
    category_id INT,
    CONSTRAINT transaction_category_id PRIMARY KEY (
