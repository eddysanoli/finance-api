...
CREATE TABLE transaction (
    ...
    beneficiary_type VARCHAR(50) NOT NULL CHECK (beneficiary_type IN ('business', 'person')),
    beneficiary_id INT,
...
CREATE TABLE transaction_occasion (
    transaction_id INT,
    occasion_id INT,
    CONSTRAINT id PRIMARY KEY (transaction_id, occasion_id),
...
CREATE TABLE transaction_category (
    transaction_id INT,
    category_id INT,
    CONSTRAINT id PRIMARY KEY (transaction_id, category_id),
...
CREATE TABLE transaction_product (
    transaction_id INT,
    product_id INT,
    CONSTRAINT id PRIMARY KEY (transaction_id, product_id),
